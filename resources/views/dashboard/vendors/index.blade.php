                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex justify-content-start align-items-center">
                        ...
                        <a href="#" class="btn btn-bg-gradient-x-red-pink btn-sm mx-1 delete-vendor" data-toggle="modal"
                          data-target="#delete_vendor_modal" title="Hapus">
                          <i class="ft-delete"></i>
                        </a>
                      </div>
                    </td>
